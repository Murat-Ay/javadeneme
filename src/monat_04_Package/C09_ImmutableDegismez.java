...
public class C09_ImmutableDegismez {
    public static void main(String[] args) {
        ...
        // bazen false verebilir, emin olmak icin == yerine equals kullanmak daha iyidir.
        ...
        /* Java basit sekilde olusturulan String'leri
          StringPool'da tutar. Yeni bir String basit sekilde olusturuldugunda
